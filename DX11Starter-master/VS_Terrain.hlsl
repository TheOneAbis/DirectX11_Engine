...
VertexToPixel main(VertexShaderInput input)
{
    ...
    //input.localPosition.y += permutation[input.localPosition.x + input.localPosition.z * 22];
	
	// Set up output struct
    VertexToPixel output;
    
    // Alter the y translation portion of world matrix w/ perlin noise
    input.localPosition.y += FractalBrownianMotion(input.localPosition.x * noiseDensity.x + noiseOffset, input.localPosition.z * noiseDensity.y + noiseOffset, 1, localPerm);
